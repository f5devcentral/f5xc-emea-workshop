...
This is done by checking the parameter value against pre defined rules. For example blocking the request if a specific parameter allowed value is numbers but when inspected it has characters.
