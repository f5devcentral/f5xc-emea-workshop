...
1. In the main left tab go to **Reports**, click on the **Full report** report name.
...
3. In the main left tab go to **Reports**, click on the **Full on Attack Signatures** report name.
